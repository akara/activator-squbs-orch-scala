package org.squbs.orchsample.svc

import akka.pattern.AskTimeoutException
import akka.util.Timeout
import org.squbs.orchsample.msgs._
...
class SampleOrchestrationService extends RouteDefinition {
        ...
        respondWithMediaType(`text/html`) {
          ...
          complete {
            <html>
              <body>
                <h1>Say hello to
                  <i>SampleOrchestrationService</i>
                  on
                  <i>squbs</i>
                  ,
                  <i>spray-routing</i>
